...
public class RecordDemo {
    public static void main(String[] args) {
        ...
        //Person prasad3 = new Person(null, "Thakur", LocalDate.of(1980, Month.JULY, 16), "880 Powder Mill Road, Wilmington DE 19803");

        System.out.println("Are they equal? " + (prasad1.equals(prasad2)));
        Person.getFullName(prasad1);
    }
    ...
    record Person(String firstName, String lastName, LocalDate birthDate, String address) {
        ...
        public static void getFullName(Person persn) {
            System.out.println(persn.firstName() + " " + persn.lastName());
        }
